export default {
  ...
  tagline:
    'Una comunidad de actuarios y desarrolladores que construyen software actuarial de código abierto.',
  open_source_by_actuaries: 'Software de código abierto por actuarios',
  stars_forks_update:
    'Las estrellas y los forks se actualizan automáticamente cada dos minutos.',
  ...
  quote2:
    'En el código abierto real, tienes derecho a controlar tu propio destino.',
  quote2_author: 'Linus Torvalds, creador de Linux',
  quote3:
    'Ciertamente hay un fenómeno en torno al código abierto. Sabes que el software libre será un área vibrante. Se harán muchas cosas interesantes allí.',
  quote3_author: 'Bill Gates, fundador de Microsoft',
  quote4:
    'Una vez que el código abierto es lo suficientemente bueno, competir con él sería una locura.',
  quote4_author: 'Larry Ellison, fundador de Oracle',
  quote5:
    'El empoderamiento de los individuos es una parte clave de lo que hace que el código abierto funcione, ya que al final, las innovaciones tienden a provenir de grupos pequeños, no de esfuerzos estructurados grandes.',
