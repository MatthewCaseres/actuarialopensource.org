          ...
          items={[
            ...(debug
              ? [
                  {
                    label: 'ConfigCopy',
                    icon: <CodeBracketIcon className="h-5 w-5 text-white" aria-hidden="true" />,
                    onClick: copyConfig,
                  },
                ]
              : []),
            {
              label: 'Run',
              icon: <PlayIcon className={`h-5 w-5 text-white ${isLoading ? "animate-pulse" : ""}`} aria-hidden="true" />,
              onClick: run,
            ...
            {
              label: 'Stop',
              icon: <StopIcon className="h-5 w-5 text-white" aria-hidden="true" />,
              onClick: stop,
              hidden: !isRunning,
            },
            {
