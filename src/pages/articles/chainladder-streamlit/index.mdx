...
The GitHub Actions say what you need to know. The benefit of Infrastructure as Code (IaC) is that you don't need to maintain a word document that says which buttons to press. 
