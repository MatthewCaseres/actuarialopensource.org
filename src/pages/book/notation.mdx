...
import timeDiagram from './images/time-diagram.svg'
...
Prior to computers, actuarial calculations used in the insurance industry were done on paper. The notation was designed to be easy to write and flexible. We will largely avoid actuarial notation because it is not easy to type on a computer and can be written using Python code.
